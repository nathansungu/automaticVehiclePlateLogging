import {z} from "zod";
export const recordAttendanceValidation = z.object({
...
export const getAttendanceByDepartmentValidation = z.object({
    departmentId: z.number().min(1, "Department ID is required"),
});

export const getAllAttendanceRecordsValidation = z.object({
